...
product list will change. 

Use BOTH filter and map to create new arrays to iterate through and display on the screen. 

Create themes using CSS Custom Properties. 
...
DOM Manipulation: 
- Users can change the UI easily and smoothly

File Organization: 
- Vite folder structure is designed for better organization. 
- Files are imported into indexJS and StyleCSS
